// @ts-nocheck
"use client";
// Ported verbatim from INDmoney Docs/frames.jsx. The fake PhoneFrame
// components are kept temporarily so leafcanvas keeps rendering during the
// port; Phase 5 swaps them for real <ScreenImage>.
